...
Card_tests.exe: Card.cpp Card_tests2.cpp
	$(CXX) $(CXXFLAGS) $^ -o $@

# Pack_public_test.exe: Card.cpp Pack.cpp Pack_public_test.cpp
# 	$(CXX) $(CXXFLAGS) $^ -o $@

Dealer_tests.exe: Chips.cpp Card.cpp Hand.cpp Bankroll.cpp Dealer.cpp Dealer_tests.cpp
	$(CXX) $(CXXFLAGS) $^ -o $@

Chips_tests.exe: Chips.cpp Chips_tests.cpp
	$(CXX) $(CXXFLAGS) $^ -o $@

Bankroll_tests.exe: Chips.cpp Bankroll.cpp Bankroll_tests.cpp
	$(CXX) $(CXXFLAGS) $^ -o $@

Pack_tests.exe: Card.cpp Pack.cpp Pack_tests2.cpp
	$(CXX) $(CXXFLAGS) $^ -o $@
...
#   --filter=':- .gitignore' \
#   ../p3-euchre/ \
#   jklaris@login.engin.umich.edu:p3-euchre-copy/